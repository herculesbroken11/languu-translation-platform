...
import { LANGUAGES, SUPPORTED_AUDIO_FORMATS, MAX_FILE_SIZE } from '@/utils/constants';
...
const AudioUploadPanel: React.FC = () => {
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!fileExtension || !SUPPORTED_AUDIO_FORMATS.includes(fileExtension)) {
      setError(`Unsupported file format. Supported formats: ${SUPPORTED_AUDIO_FORMATS.join(', ')}`);
      return;
    }
